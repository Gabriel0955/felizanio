...
<head>
    ...
    <meta name="description" content="Carta digital animada de Año Nuevo 2026 - Un mensaje especial lleno de deseos, fuegos artificiales y celebración">
...
<body>
    ...
    <div class="main-content" id="mainContent">
        ...
        <div class="surprise-box" onclick="openSurprise()" title="¡Haz clic para una sorpresa!" aria-label="Botón de sorpresas" role="button" tabindex="0">
            🎁
        </div>
        ...
        <div class="modal" id="surpriseModal" role="dialog" aria-modal="true" aria-labelledby="surprise-title">
            <div class="modal-content">
                <span class="close-modal" onclick="closeModal()" role="button" aria-label="Cerrar" tabindex="0">&times;</span>
        ...
        <div class="container">
            <main class="card" role="main">
                ...
                <div class="message">
                    <?php
                    $messages = [
                        "Amiga, que este nuevo año esté lleno de aventuras increíbles y momentos inolvidables. ¡Espero seguir siendo parte de muchos de ellos!",
                        "Que todos tus sueños se hagan realidad y que la felicidad te acompañe siempre. ¡Te lo mereces todo lo mejor!",
                        "Que el 2026 te traiga amor, salud, éxito y muchas razones para sonreír cada día. ¡Cuenta conmigo siempre!",
                        "Brindo por ti amiga, por nuestra amistad, y por todo lo genial que está por venir. ¡Será un año increíble!",
                        "Cada día del 2026 será una nueva oportunidad para que sigas siendo la persona maravillosa que eres. ¡Gracias por tu amistad!"
                    ];
                    ...
                    $wishes = [
                        ...
                        "💙 Amistad verdadera y sincera",
                        "🌟 Éxito en todos tus proyectos",
                        "😊 Risas y momentos felices",
                        "🎯 Que cumplas todas tus metas",
                        "🌈 Días llenos de color y alegría",
                ...
                <div class="signature">
                    ...
                    Tu amigo que te aprecia un montón 🙌<br>
                    <?php echo date('Y'); ?>
                </div>
            </main>
        </div>
